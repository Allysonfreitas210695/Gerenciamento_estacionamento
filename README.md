...
All apps need be included to INSTALLED_APPS variable at **backend/settings.py**.
...
Let's include our view to list books in the **backend/urls.py** file to register it in the router. 
